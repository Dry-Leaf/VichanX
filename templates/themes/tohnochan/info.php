<?php
	...
	// Theme name
	$theme['name'] = 'tohnochan';
	// Description (you can use Tinyboard markup here)
	$theme['description'] = 'tohnochans main page';
	$theme['version'] = 'v1.0';
	...
	$theme['config'][] = Array(
		...
		'name' => 'icon',
		'type' => 'text',
		'default' => 'https://tohno-chan.org/templates/themes/tohnochan/milky.jpg',
		'size' => 50
	);
	...
	$theme['config'][] = Array(
		...
		'name' => 'description',
		'type' => 'textarea',
		'default' => 'This is where the waifus live'
	);
		...
		'name' => 'imageofnow',
		'type' => 'text',
		'default' => 'https://i.imgur.com/3eTnvuC.jpg',
		'size' => 50
	);
		...
		'name' => 'videoofnow',
		'type' => 'text',
		'default' => 'https://www.youtube.com/watch?v=qu6rZwz2PgA',
		'size' => 50
	);
	...
	$theme['config'][] = Array(
		...
		'type' => 'text',
		'default' => 'index.css',
		'comment' => '(eg. "index.css" - see templates/themes/tohnochan for details)'
	);
