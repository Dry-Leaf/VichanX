...
/* main.js */
class __TwigTemplate_94af43b6022bbbfede4df01218cc56a5b96f4dfc87339caaa62773e80f107c48 extends \Twig\Template
{
...
var selectedstyle = '";
        echo addslashes($this->getAttribute($this->getAttribute(($context["config"] ?? null), "default_stylesheet", []), 0, []));
        // line 114
        echo "';
var styles = {
\t";
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["stylesheet"]) {
            echo "'";
            echo addslashes($this->getAttribute($context["stylesheet"], "name", []));
            echo "' : '";
            echo addslashes($this->getAttribute($context["stylesheet"], "uri", []));
            // line 116
            echo "',
\t";
        }
...
\t";
        // line 125
        if ($this->getAttribute(($context["config"] ?? null), "stylesheets_board", [])) {
            // line 130
            echo "
\t\tif (board_name) {
...
\tvar pass = '';
\tvar chars = '";
        echo $this->getAttribute(($context["config"] ?? null), "genpassword_chars", []);
        // line 326
        echo "';
\tfor (var i = 0; i < 8; i++) {
...
\t\t\tif (get_cookie('";
        echo $this->getAttribute($this->getAttribute(($context["config"] ?? null), "cookies", []), "js", []);
        // line 328
        echo "')) {
...
var post_date = \"";
        // line 391
        echo $this->getAttribute(($context["config"] ?? null), "post_date", []);
        echo "\";
var max_images = ";
        // line 392
...
";
        // line 396
        if ($this->getAttribute(($context["config"] ?? null), "google_analytics", [])) {
            // line 398
            echo "

var _gaq = _gaq || [];_gaq.push(['_setAccount', '";
            echo $this->getAttribute(($context["config"] ?? null), "google_analytics", []);
            echo "']);";
            if ($this->getAttribute(($context["config"] ?? null), "google_analytics_domain", [])) {
                echo "_gaq.push(['_setDomainName', '";
                echo $this->getAttribute(($context["config"] ?? null), "google_analytics_domain", []);
                echo "'])";
            }
            if ( !$this->getAttribute(($context["config"] ?? null), "google_analytics_domain", [])) {
...
";
        // line 400
        if (($this->getAttribute(($context["config"] ?? null), "statcounter_project", []) && $this->getAttribute(($context["config"] ?? null), "statcounter_security", []))) {
            // line 401
            echo "var sc = document.createElement('script');
sc.type = 'text/javascript';
sc.innerHTML = 'var sc_project=";
            // line 403
            echo $this->getAttribute(($context["config"] ?? null), "statcounter_project", []);
            echo ";var sc_invisible=1;var sc_security=\"";
            echo $this->getAttribute(($context["config"] ?? null), "statcounter_security", []);
...
";
    ...
    {
        return array (  535 => 407,  526 => 403,  522 => 401,  520 => 400,  517 => 399,  501 => 398,  499 => 396,  492 => 392,  488 => 391,  462 => 389,  460 => 368,  454 => 364,  452 => 363,  420 => 362,  411 => 334,  406 => 328,  323 => 326,  267 => 246,  253 => 191,  251 => 182,  231 => 180,  229 => 165,  227 => 164,  193 => 163,  191 => 133,  187 => 131,  179 => 130,  177 => 125,  165 => 124,  158 => 116,  150 => 115,  144 => 114,  30 => 112,);
    }
    ...
    {
        return new Source("", "main.js", "/home/tcv3dev/bluearchive.tohno-chan.org/templates/main.js");
    }
}
