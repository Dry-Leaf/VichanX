...
function make_webm_thumbnail($filename, $thumbnail, $width, $height, $duration) {
  ...
  exec("$ffmpeg -strict -2 -i $filename -ss 0 -t $duration -r 10 -vf scale=$width:$height -f image2pipe -vcodec ppm - | convert -delay 10 -loop 0 -layers Optimize - $thumbnailfc 2>&1", $ffmpeg_out, $ret);
